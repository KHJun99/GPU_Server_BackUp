...
def main(env_cfg: ManagerBasedRLEnvCfg, agent_cfg):
    ...
    # PathonAI ckpt is 28-dim input (no last_action obs). Strip it for compat.
    if hasattr(env_cfg.observations.policy, "actions"):
        delattr(env_cfg.observations.policy, "actions")
        print("[INFO] PathonAI eval: stripped 'actions' obs term (36 → 28 dim)")
