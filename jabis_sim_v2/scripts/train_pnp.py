"""Pure PPO from scratch for Pick & Place task."""
...
def main():
    ...
    if args.log_dir is None:
        ...
        args.log_dir = f"logs/rsl_rl/pnp_{ts}"
    ...
    print(f"[INFO] starting Pick & Place training: {args.max_iter} iterations", flush=True)
